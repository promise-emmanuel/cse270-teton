...
class TestSmokeTest():
  ...
  def test_admin(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("promise")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("promise")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("promise")
    ...
    actions = ActionChains(self.driver)
    actions.move_to_element(element).release().perform()
    self.driver.find_element(By.NAME, "lname").send_keys("emmanuel")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("protech")
  ...
  def test_nameLogo(self):
    self.driver.get("http://127.0.0.1:5502/teton/1.6/index.html")
    self.driver.set_window_size(1382, 800)
    self.driver.find_element(By.LINK_TEXT, "Home").click()
